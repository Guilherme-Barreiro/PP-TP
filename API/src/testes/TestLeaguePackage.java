...
// === Clubes e Equipas ===
        ...
        try {
            Tslb.addPlayer(p1); Tslb.addPlayer(p2); Tslb.addPlayer(p3); Tslb.addPlayer(p4); Tslb.addPlayer(p5);
            Tslb.addPlayer(p6); Tslb.addPlayer(p7); Tslb.addPlayer(p8); Tslb.addPlayer(p9); Tslb.addPlayer(p10); Tslb.addPlayer(p11);

            Tfcp.addPlayer(q1); Tfcp.addPlayer(q2); Tfcp.addPlayer(q3); Tfcp.addPlayer(q4); Tfcp.addPlayer(q5);
            Tfcp.addPlayer(q6); Tfcp.addPlayer(q7); Tfcp.addPlayer(q8); Tfcp.addPlayer(q9); Tfcp.addPlayer(q10); Tfcp.addPlayer(q11);
        } catch (Exception err) {
        ...
        System.out.println("Épocas: " + liga.getSeasons().length);
    }
}
