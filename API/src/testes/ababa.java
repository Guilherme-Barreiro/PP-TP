...
public class Ababa {
    ...
    public static void main(String[] args) {
        ...
        Season s2024 = new Season("Liga 2024", 2024, 20);
        Season s2025 = new Season("Liga 2025", 2025, 20);
        Season s2026 = new Season("Liga 2026", 2026, 20);

        liga.createSeason(s2024);
        liga.createSeason(s2025);
        liga.createSeason(s2026);
        ...
        Player p4 = new Player("Jbenfica4", LocalDate.of(1997, 4, 4), 27, "Portugal", mid, "", 84, 74, 69, 79, 64, 1.83f, 78f, null);
        ...
        Player p8 = new Player("Jbenfica8", LocalDate.of(2000, 8, 8), 24, "Portugal", mid, "", 88, 78, 73, 83, 68, 1.87f, 82f, null);
        ...
        Player p12 = new Player("Jbenfica12", LocalDate.of(2001, 12, 12), 23, "Portugal", mid, "", 92, 82, 77, 87, 72, 1.91f, 86f, null);
        ...
        Player p16 = new Player("Jbenfica16", LocalDate.of(1999, 4, 16), 25, "Portugal", mid, "", 96, 86, 81, 91, 76, 1.95f, 90f, null);
        ...
        Player q4 = new Player("Jporto4", LocalDate.of(2000, 9, 20), 24, "Portugal", mid, "", 20, 90, 85, 95, 80, 1.82f, 78f, null);
        ...
        Player q8 = new Player("Jporto8", LocalDate.of(2001, 1, 24), 23, "Portugal", mid, "", 24, 94, 89, 99, 84, 1.78f, 82f, null);
        ...
        Player q16 = new Player("Jporto16", LocalDate.of(2002, 9, 1), 22, "Portugal", mid, "", 32, 97, 97, 100, 92, 1.70f, 90f, null);
        ...
        for (IClub club : s2024.getCurrentClubs()) {
